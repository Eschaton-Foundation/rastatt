...
**What's new in version 7.34**
Version 7.34 brings important security enhancements, new compatibility, and overall improvements to make your import and export experience smoother and more reliable.

* **Events Calendar Support**
You can now import and export Events Calendar data, making it simpler to manage events across different sites or platforms.

* **Performance Improvements**
We’ve refined key parts of the plugin to deliver better stability and faster processing during imports and exports.

* **Bug Fixes**
Several user-reported issues have been resolved to ensure a more seamless workflow.

* **Critical Security Patch**
This update addresses a PHP Object Injection vulnerability found in the Single CSV Import feature. Updating to this version is strongly recommended for all users.
...
Security update: This release patches a critical PHP Object Injection vulnerability in the Single CSV Import feature. We strongly recommend you updating to ensure your site remains secure. This version also includes Events Calendar import/export support and general performance improvements.
